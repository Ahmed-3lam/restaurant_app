      ...
      appBar: AppBar(
          ...
          title: Text(
            ...
            style: FontStyleUtilities.h3(
                fontColor: ColorUtils.kcBlack, fontWeight: FWT.medium),
          )),
      body: Column(
        children: [
          ...
          Text(
            ...
            style: FontStyleUtilities.h2(
                fontColor: ColorUtils.kcPrimary, fontWeight: FWT.medium),
          ),
          ...
          Column(
            ...
            children: [
              ...
              Text(
                ...
                style: FontStyleUtilities.t5(fontWeight: FWT.semiBold),
              )
            ],
          ),
          const Spacer(),
